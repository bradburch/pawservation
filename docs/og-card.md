...
| --------------------------- | ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `public/img/og-card.png`    | `pageHead` (`/`, `/how-it-works`, `/privacy`, `/terms`) and `demo.html` | A prospective **sitter**, being recruited.                                              |
| `public/img/og-booking.png` | `embedCardTags` (`/embed/:slug`)                                        | A **pet owner** who has been texted her own sitter's booking link.                      |
| The icon set                | Every page's `<link rel="icon">` / `apple-touch-icon`                   | Whoever is looking at a browser tab, a home screen, or an iMessage bubble with no card. |
