...
export const SERVICE_PRESETS: ServicePreset[] = [
  {
    ...
    template: 'walk',
    label: 'Pack Walks',
    summary: 'Group walks · weekdays 10–2 · up to 8 dogs',
    icon: 'paw',
    rateUnit: 'visit',
  ...
  },
  {
    ...
    summary: 'Two group walks · weekdays 10–2 and 2–5 · up to 8 dogs each',
    icon: 'paw',
    rateUnit: 'visit',
  ...
  },
  {
    ...
    template: 'walk',
    label: 'Solo Walker',
    summary: 'One-on-one walks · weekdays 10–4 · up to 4 dogs',
    icon: 'paw',
    rateUnit: 'visit',
