        ...
        <div class="wrap">
          ...
          <div class="qa">
            ...
            <div class="qa-item">
              ...
              <p><strong>No.</strong> Your caps and your time off hold the day, and a request holds its space from the moment it arrives, not from when you confirm it. Caps count animals, so a booking for three dogs needs three spaces free; a day that can&rsquo;t fit them isn&rsquo;t offered. A night holds one house sit, whatever its pet count, because you can only sleep in one house, and the same rule keeps a house sit and a boarding apart. If you&rsquo;ve connected Google Calendar, an event you keep there blocks matching requests too, because the sync runs both ways; it reads six months ahead, or as far as your booking horizon when you set one longer. One choice switches that whereabouts check off: setting house sitting and boarding to &ldquo;No limit&rdquo;, which is there for sitters who would rather sort clashes out themselves.</p>
            </div>
            <div class="qa-item">
        ...
        <div class="wrap">
          ...
          <div class="features">
            ...
            <div class="feature">
              ...
              <p>You stay at the client&rsquo;s home, again over a range of dates, under its own cap. And because you can only sleep in one house, a night holds one house sit, and a boarding at your own place is held apart from it too, by however much you say (see below).</p>
            </div>
            <div class="feature">
        ...
        <div class="wrap">
          ...
          <div class="wf-math">
            ...
            <div class="wf-pair">
              ...
              <p>You can&rsquo;t sleep at a client&rsquo;s house and keep a boarder at your own, and you can&rsquo;t sleep at two clients&rsquo; houses either, so a night holds one house sit and holds it apart from any boarding. That is about houses, not animals: a house sit for one cat fills the night as completely as a house sit for three dogs, and no cap you set makes room for a second. You say by how much the two may overlap: never overlap, one handover day (the default), one handover day at each end of a stay, or no limit. On any of the numbered settings a shared day only ever counts as a handover: one thing ending as the other begins, so a boarding dropped into the middle of a house sit is refused whether you allow one shared day or two, and so is a second house sit dropped into the middle of the first. Both stays are judged, so the answer is the same whichever of them was booked first. No limit works differently. It switches the check off, so nothing is held apart at all and a boarding or another house sit can land anywhere inside a house sit. Choose it only if you&rsquo;d rather sort clashes out yourself. Boarding is not affected by any of this: boarders are at your own home, so several at once is normal, and how many at once is what your cap is for.</p>
            </div>
            <div class="wf-pair">
