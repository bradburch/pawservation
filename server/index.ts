        ...
        <div class="wrap">
          ...
          <div class="wf-math">
            ...
            <div class="wf-pair">
              ...
              <p>You can&rsquo;t sleep at a client&rsquo;s house and keep a boarder at your own, so the two are held apart, and you say by how much: never overlap, one handover day (the default), one handover day at each end of a stay, or no limit. On any of the numbered settings a shared day only ever counts as a handover: one thing ending as the other begins, so a boarding dropped into the middle of a house sit is refused whether you allow one shared day or two. No limit works differently. It switches the check off, so the two stop being held apart at all and a boarding can land anywhere inside a house sit. Choose it only if you&rsquo;d rather sort clashes out yourself. What the rule does not do is hold two house sits apart from each other: your house-sit cap counts pets, not houses, so a second house sit on the same night is refused only once its animals would take you over that cap. If you only ever sit one home at a time, the honest workaround is a house-sit cap of one pet, which also turns away every client arriving with two dogs, and there is no setting that separates the two.</p>
            </div>
            <div class="wf-pair">
