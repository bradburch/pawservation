        ...
        <div class="wrap">
          ...
          <div class="qa">
            ...
            <div class="qa-item">
              ...
              <p><strong>Not on your caps, your time off, or your Google Calendar. There is one exception, and if you house-sit you should read it now.</strong> Your caps and your time off hold the day, and a request holds its space from the moment it arrives, not from when you confirm it. Caps count animals, so a booking for three dogs needs three spaces free; a day that can&rsquo;t fit them isn&rsquo;t offered. If you&rsquo;ve connected Google Calendar, an event you keep there blocks matching requests too, because the sync runs both ways. The exception is that it does not keep you in one house at a time: a boarding and a house sit are held apart, but two house sits on the same night are held apart only by your house-sit cap, and that cap counts pets rather than houses. Set it to one pet and a second house sit is refused, and so is any client bringing two dogs. There is no setting that does the first without the second.</p>
            </div>
            <div class="qa-item">
              <h3>What if I move or delete a booking&rsquo;s event in Google Calendar?</h3>
              <p><strong>Deleting cancels it. Moving doesn&rsquo;t move it.</strong> Deleting a booking&rsquo;s event in Google cancels that booking and emails your client. A booking you took off your own calendar is one you&rsquo;re not doing. Dragging that same event to different dates is not a change Pawservation reads: the booking keeps the dates your client booked, those stay the dates holding your capacity, and the next time anything happens to that booking the event is rewritten back to them. Drag it far enough out that it leaves the window Pawservation checks (yesterday to six months out, or as far as your own booking horizon if you let clients book beyond that) and it counts as deleted, cancellation email included. A cancellation is final: there is no un-cancel in your dashboard, so putting that booking back means your client sending the request again and you confirming it again. Move a booking by changing the booking, not the event.</p>
            </div>
            <div class="qa-item">
        ...
        <div class="wrap">
          ...
          <div class="features">
            ...
            <div class="feature">
              ...
              <p>You stay at the client&rsquo;s home, again over a range of dates, under its own cap. And because you can&rsquo;t sleep at a client&rsquo;s house and keep a boarder at your own, house sitting and boarding are held apart, by however much you say (see below).</p>
            </div>
            <div class="feature">
